...
export function CardPlayButton ({id}) {
    ...
    return (
        <button onClick={handleClick} className="card-play-button rounded-full bg-green-500 p-4">
            {isPalyingPlaylist ? <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000" class="bi bi-pause-fill" viewBox="0 0 16 16">
                <path d="M5.5 3.5A1.5 1.5 0 0 1 7 5v6a1.5 1.5 0 0 1-3 0V5a1.5 1.5 0 0 1 1.5-1.5m5 0A1.5 1.5 0 0 1 12 5v6a1.5 1.5 0 0 1-3 0V5a1.5 1.5 0 0 1 1.5-1.5"/>
                </svg> : <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#000" class="bi bi-play-fill" viewBox="0 0 16 16">
